...
export default function Message() {
    ...
    const loadMore = async (type = 0, fake = 0) => {
        ...
        let res = !type ? await rechargeRecords({
            page,
            size: 10,
            username: userinfo.username
        }) : await withdrawalRecords({page, size: 10, username: userinfo.username})
        setPage(page + 1)
                ...
                >
                    ...
                    <div className={styles.datas}>
                        <div className={styles.data_item}>
                            <h3>${formatAmount(user?.user?.noneUsefulBalance || 0)}</h3>
                            <p>{t('wallet.freezingBalance')}</p>
                        </div>
                        <div className={styles.data_item}>
                                ...
                                >
                                    <div className={styles.item} style={{
                                        ...
                                        <div className={styles.amount}
                                             style={{color: activeIndex == '0' ? '#ff6767' : '#44a53b'}}>
