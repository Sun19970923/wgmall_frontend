...
import Swiper from "../../components/SwiperOrder";
            ...
            <div className={styles.indexBody}>
                ...
                >
                    ...
                    >
                        ...
                        {(user?.user?.noneUsefulBalance || 0) > 0 && (
                            <div style={{ marginTop: '10px' }}>
                                <h2>
                                    {t('wallet.freezingBalance')}
                                    <span style={{ marginLeft: 8, color: '#000' }}>
                                        ${formatAmount(user?.user?.noneUsefulBalance)}
                                    </span>
                                </h2>
                            </div>
                        )}
